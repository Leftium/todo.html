...
/**
 * Get bounding rectangle of the text inside an input element.
 * Used to place Display tooltip at correct location above Inputter.
 * Based on: Rob W's http://stackoverflow.com/questions/6930578/
 *
 ...
 * @param debug Optional boolean. If true, the created test layer will not
 * be removed.
 */
function getTextBoundingRect(input, selectionStart, selectionEnd, debug) {
    ...
    var height = getInputCSS('height', true);
    ...
    for (var i = 0, property; property = listOfModifiers[i]; i++) {
    ...
    function getInputOffset() {
      ...
      var scrollTop  = win.pageYOffset ||
                       (isBoxModel && docElem.scrollTop) || body.scrollTop;
      var scrollLeft = win.pageXOffset ||
                       (isBoxModel && docElem.scrollLeft) || body.scrollLeft;
      return {
