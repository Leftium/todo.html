...
(function($) {
    ...
    $.extend($.twFile,{
        ...
        load: function(filePath) {
            debug.debug('twFile.load: ' + filePath);
        ...
        save: function(filePath,content) {
            debug.debug('twFile.save: ' + filePath);
        ...
        availableDrivers: function() {
            var driverList =  $.grep(this.driverList, function(driverName, i) {
                return drivers[driverName].isAvailable();
            });

            debug.debug('twFile.availableDrivers: ' + driverList);
            return driverList;
        },
    ...
    drivers.activeX = {
        ...
        isAvailable: function() {
            try {
                ...
                debug.info('exception @activeX.isAvailable: ' + ex);
                return false;
            }
            return true;
        },
        loadFile: function(filePath) {
            ...
            try {
                ...
                debug.error('exception @activeX.loadFile: ' + filePath + '\n\n' + ex);
                return null;
            }
            return content;
        },
        createPath: function(path) {
            ...
            try {
                ...
                debug.error('exception @activeX.createPath: ' + ex);
            }
            return false;
        },
        copyFile: function(dest,source) {
            ...
            try {
                ...
                debug.error('exception @activeX.copyFile: ' + ex);
                return false;
            }
            return true;
        },
        saveFile: function(filePath,content) {
            ...
            try {
                ...
                debug.error('exception @activeX.saveFile: ' + filePath + '\n\n' + ex);
                return null;
            }
            return true;
        }
        ...
        loadFile: function(filePath) {
            ...
            if(window.Components) {
                try {
                    ...
                    debug.error('exception @mozilla.loadFile: ' + filePath + '\n\n' + ex);
                    return false;
                }
            }
            return null;
        ...
        saveFile: function(filePath,content) {
            ...
            if(window.Components) {
                try {
                    ...
                    debug.error('exception @mozilla.saveFile: ' + filePath + '\n\n' + ex);
                    return false;
                }
            }
            return null;
    ...
    drivers.tiddlySaver = {
        ...
        loadFile: function(filePath) {
            ...
            try {
                ...
                debug.error('exception @tiddlySaver.loadFile: ' + filePath + '\n\n' + ex);
            }
            return null;
        },
        saveFile: function(filePath,content) {
            try {
                ...
                debug.error('exception @tiddlySaver.saveFile: ' + filePath + '\n\n' + ex);
            }
            return null;
        }
    };
